...
import ro.pub.elth.itee.oana.config.audit.AuditEventConverter;
import ro.pub.elth.itee.oana.domain.PersistentAuditEvent;
...
import static ro.pub.elth.itee.oana.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
